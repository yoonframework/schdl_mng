...
import AdminMbrSrchDpcnModal from "schdl_mng/admin/mbr/AdminMbrSrchDpcnModal";
 ...
 * @returns
 */
function AdminMbrReg({ setModalInfo }) {
    // URL 위치 및 상태 정보 Hook
    ...
    const onClickSrchDpcn = (e) => {
        setModalInfo((prevState) => {
            return {
                ...
                title: "아이디 중복확인",
                content: (
                    <AdminMbrSrchDpcnModal callback={onModalActionCallback} />
                ),
            };
        });
    };
