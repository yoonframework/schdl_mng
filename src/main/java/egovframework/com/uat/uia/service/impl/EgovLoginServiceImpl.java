...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	...
	@Override
	public LoginVO actionSessionReload(LoginVO vo) throws EgovBizException {
		// 2. 아이디와 암호화된 비밀번호가 DB와 일치하는지 확인한다.
		return loginDAO.actionLogin(vo);
	}

	@Override
	@CacheEvict(value = "sessionMenu", key = "{#vo.uniqId}")
	public void loginCacheReset(LoginVO vo) throws EgovBizException {

	}

	@Override
	@CacheEvict(value = "sessionMenu", allEntries = true)
	public void logoutCacheReset() throws EgovBizException {
