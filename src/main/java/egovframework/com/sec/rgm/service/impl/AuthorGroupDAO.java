...
public class AuthorGroupDAO extends EgovComAbstractDAO {
	 ...
	 * @exception Exception
	 */
	public void insertAuthorGroup(AuthorGroup authorGroup) throws EgovBizException {
	 ...
	 * @exception Exception
	 */
	public void updateAuthorGroup(AuthorGroup authorGroup) throws EgovBizException {
     ...
     * @throws Exception
     */
	public AuthorGroupVO selectMemberAuthor(MberManageVO mberManageVO) throws DataAccessException {
		// TODO Auto-generated method stub
		return selectOne("authorGroupDAO.selectMemberAuthor", mberManageVO);
	}
}