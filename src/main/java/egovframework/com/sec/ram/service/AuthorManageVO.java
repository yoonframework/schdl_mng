...
public class AuthorManageVO extends AuthorManage {
	...
	public List<AuthorManageVO> getAuthorManageList() {
		if (this.authorManageList == null) {
			return null;
		} else {
			List<AuthorManageVO> list = new ArrayList<>();
			list.addAll(this.authorManageList);
			return list;
		}
	}
	...
	public void setAuthorManageList(List<AuthorManageVO> authorManageList) {
		if (authorManageList != null) {
			this.authorManageList = new ArrayList<AuthorManageVO>();
			for (AuthorManageVO vo : authorManageList) {
				this.authorManageList.add(vo);
			}
		}
	}
