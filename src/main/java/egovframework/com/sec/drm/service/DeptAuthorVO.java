...
public class DeptAuthorVO extends DeptAuthor {
	...
	public List<DeptAuthorVO> getDeptAuthorList() {
		if (this.deptAuthorList == null) {
			return null;
		} else {
			List<DeptAuthorVO> list = new ArrayList<>();
			list.addAll(this.deptAuthorList);
			return list;
		}
	}
	/**
	...
	public void setDeptAuthorList(List<DeptAuthorVO> deptAuthorList) {
		if (deptAuthorList != null) {
			this.deptAuthorList = new ArrayList<DeptAuthorVO>();
			for (DeptAuthorVO vo : deptAuthorList) {
				this.deptAuthorList.add(vo);
			}
		}
	}
	/**
	...
	public void setDeptList(List<DeptAuthorVO> deptList) {
		if (deptList != null) {
			this.deptList = new ArrayList<DeptAuthorVO>();
			for (DeptAuthorVO vo : deptList) {
