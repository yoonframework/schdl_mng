 ...
 *               이삼섭 최초생성 2011. 7. 01. 이기하 패키지 분리(stm.log -> sym.log.clg)
 *
...
public class EgovLoginLogServiceImpl extends EgovAbstractServiceImpl implements EgovLoginLogService {
	 ...
	 */
	@Override
	public void logInsertLoginLog(LoginLog loinLog) throws EgovBizException, FdlException {
	 ...
	 */
	@Override
	public LoginLog selectLoginLog(LoginLog loginLog) throws EgovBizException {
	...
	@Override
	public Map<?, ?> selectLoginLogInf(LoginLog loinLog) throws EgovBizException {
	...
	@Override
	public int selectLoginLogInfCntForUser(String uniqId) throws EgovBizException {
		return loginLogDAO.selectLoginLogInfCntForUser(uniqId);
	}
}
