...
public class EgovConfigWebDispatcherServlet implements WebMvcConfigurer {
	...
	@Bean
	public CustomAuthenticInterceptor customAuthenticInterceptor() {
		return new CustomAuthenticInterceptor();
	}
...
//				"/**/*.do").excludePathPatterns("/uat/uia/actionLoginAPI.do", "/uat/uia/actionLogoutAPI.do");
		registry.addInterceptor(customAuthenticInterceptor()).addPathPatterns("/**/*.do")
				.excludePathPatterns("/uat/uia/actionLoginAPI.do", "/uat/uia/actionLogoutAPI.do", "/stng/selectSession.do");
	}
...
//	}
	...
	// 김기윤
	// -------------------------------------------------------------
	// StringHttpMessageConverter encoding 변경 UTF-8
	// -------------------------------------------------------------
	@Override
