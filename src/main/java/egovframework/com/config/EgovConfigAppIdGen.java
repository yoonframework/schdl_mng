...
public class EgovConfigAppIdGen {
	 ...
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovAuthoListIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(egovDataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(10)
				.setTable("COMTECOPSEQ")
				.setTableName("AUTHO_LIST_ID")
				.setPreFix("AUTHO_")
				.setCipers(12)
				.setFillChar('0')
				.build();
	 ...
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovFunctionAuthoIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(egovDataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(10)
				.setTable("COMTECOPSEQ")
				.setTableName("FUNCTION_AUTHO_ID")
				.setPreFix("FUNCTION_")
				.setCipers(11)
				.setFillChar('0')
				.build();
	 ...
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovProgrListIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(egovDataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(10)
				.setTable("COMTECOPSEQ")
				.setTableName("PROGR_LIST_ID")
				.setPreFix("PROGR_")
				.setCipers(12)
				.setFillChar('0')
				.build();
	 ...
	 * @Author : 김기윤
	 * @Date : 2022. 2. 17.
	 * @Method Name : deptIdGnrService
	 * @return : EgovTableIdGnrServiceImpl
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl deptIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(1)
				.setTable("COMTECOPSEQ")
				.setTableName("DEPT_ID")
				.setPreFix("DEPT_")
				.setCipers(15)
				.setFillChar('0')
				.build();
	 ...
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl crqfcIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(1)
				.setTable("COMTECOPSEQ")
				.setTableName("CRQFC_ID")
				.setPreFix("CRQFC_")
				.setCipers(14)
				.setFillChar('0')
				.build();
	 ...
	 * @Author : 김기윤
	 * @Date : 2022. 2. 21.
	 * @Method Name : vcatnCrtIdGnrService
	 * @return : EgovTableIdGnrServiceImpl
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl vcatnCrtIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(1)
				.setTable("COMTECOPSEQ")
				.setTableName("VCATN_CRT_ID")
				.setPreFix("VCATN_CRT_")
				.setCipers(10)
				.setFillChar('0')
				.build();
	}
	 ...
	 * @Author : 김기윤
	 * @Date : 2022. 2. 24.
	 * @Method Name : vcatnIdGnrService
	 * @return : EgovTableIdGnrServiceImpl
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl vcatnIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(1)
				.setTable("COMTECOPSEQ")
				.setTableName("VCATN_ID")
				.setPreFix("VCATN_")
				.setCipers(14)
				.setFillChar('0')
				.build();
	 ...
	 * @Author : 김기윤
	 * @Date : 2022. 2. 24.
	 * @Method Name : bsrpIdGnrService
	 * @return : EgovTableIdGnrServiceImpl
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl bsrpIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(1)
				.setTable("COMTECOPSEQ")
				.setTableName("BSRP_ID")
				.setPreFix("BSRP_")
				.setCipers(15)
				.setFillChar('0')
				.build();
	 ...
	 */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl bsrpCncdntIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource)
				.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
				.setBlockSize(1)
				.setTable("COMTECOPSEQ")
				.setTableName("BSRP_CNCDNT_ID")
				.setPreFix("CNCDNT_")
				.setCipers(13)
				.setFillChar('0')
				.build();
